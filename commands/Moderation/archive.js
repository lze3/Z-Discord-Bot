...
module.exports.run = async(Client, message, args) => {
    ...
    if (!message.member.hasPermission("MANAGE_CHANNELS")) return message.reply("you do not have permission to execute that command.").then(msg => msg.delete(50000))
    if (!channel) return message.reply("that is not a channel.").then(msg => msg.delete(50000))
    ...
    message.channel.send(`:white_check_mark: **Channel #${channel.name} was successfully archived.**`).then(msg => msg.delete(50000))
