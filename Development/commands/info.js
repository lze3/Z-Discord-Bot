...
module.exports.run = async(bot, message, args) =>
{
    ...
    .setDescription('This bot is primarily made for department related things, such as adding roles, removing roles, making announcements etc. ~~There is also a `' + prefix + "status` command to see the status of our servers~~ **Temporarily removed.**\n\nIn the future we plan on making commands to administrate the server, adding commands to stop or [re]start resource.")
